...
public class C01MwthodCreation {
    public static void main(String[] args) {
        String str = "Java ögrenmek cok zevkli";
        //Str nin ilk 4 harfini almak istesek
        str.substring(0,4);
        // bir programda kodlarinizin kisa ve anlasilir
        // olmasi icin sürekli kullanacagumiz kod bloklarini hazir olarak bir
        // yere koyar ihtiyacimiz oldukca oradan aliriza
